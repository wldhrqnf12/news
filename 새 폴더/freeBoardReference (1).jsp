...
<body>
	...
	<form action="./freeBoardReferencePro.ino">
		...
		<div style="width: 500px; float: left;" align="left">작성날짜:</div>
		<div style="width: 500px; float: left;" align="left"><input type="text" name="day"/></div>
		<div style="width: 150px; float: left;">내용 :</div>
		<div style="width: 500px; float: left;" align="left"><textarea name="content" rows="25" cols="65"  ></textarea></div>
		<div align="right">
		<div style="width: 150ox; float: left;" align="left">파일 추가:</div>
		<input type="button" value="파일 선택" onclick="file">
